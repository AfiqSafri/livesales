  ...
  return (
    <div className="min-h-screen text-gray-900">
      <div className="p-6">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2 text-gray-900">Sales Reports</h1>
          <p className="text-lg text-gray-600">Detailed revenue analytics and business insights</p>
        </div>
        ...
        <div className="mt-8 flex justify-end">
          <button className="bg-green-600 text-white px-6 py-2 rounded-lg font-medium hover:bg-green-700 transition-colors mr-3">
            Export to Excel
          </button>
