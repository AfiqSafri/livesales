    ...
    <div className="min-h-screen text-gray-900">
      <div className="p-1 sm:p-2 lg:p-4">
        ...
        <div className="mb-2 sm:mb-3 lg:mb-4">
          <h1 className="text-lg sm:text-xl lg:text-2xl font-bold mb-1 text-gray-900">Sales Reports</h1>
          <p className="text-xs sm:text-sm text-gray-600">Detailed revenue analytics and business insights</p>
        </div>

        {/* Filters */}
        <div className="bg-white rounded-lg border border-gray-200 p-2 sm:p-3 lg:p-4 mb-2 sm:mb-3 lg:mb-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 lg:gap-4">
            ...
            <div className="flex items-end">
              <button
                ...
                className="w-full bg-blue-600 text-white px-2 py-1.5 text-xs rounded-lg font-medium hover:bg-blue-700 transition-colors"
              >
                Refresh Data
              </button>
            </div>
        ...
        {/* Key Metrics */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 lg:gap-4 mb-2 sm:mb-3 lg:mb-4">
          <div className="bg-white rounded-lg border border-gray-200 p-2 sm:p-3 lg:p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs font-medium text-gray-600">Total Revenue</p>
                <p className="text-base sm:text-lg lg:text-xl font-bold text-gray-900">{formatCurrency(salesData.totalRevenue || 0)}</p>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-2 sm:p-3 lg:p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-base sm:text-lg lg:text-xl font-bold text-gray-900">{salesData.totalOrders || 0}</p>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-2 sm:p-3 lg:p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-base sm:text-lg lg:text-xl font-bold text-gray-900">{formatCurrency(salesData.averageOrderValue || 0)}</p>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-2 sm:p-3 lg:p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-base sm:text-lg lg:text-xl font-bold text-gray-900">{(salesData.conversionRate || 0).toFixed(1)}%</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 sm:gap-3 lg:gap-4 mb-2 sm:mb-3 lg:mb-4">
          <div className="bg-white rounded-lg border border-gray-200 p-2 sm:p-3 lg:p-4">
            <h3 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Revenue Trend</h3>
            <div className="h-24 sm:h-32 lg:h-40 flex items-center justify-center text-gray-500">
              <div className="text-center">
                <svg className="w-8 h-8 sm:w-12 sm:h-12 lg:w-16 lg:h-16 mx-auto mb-1 sm:mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                </svg>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-2 sm:p-3 lg:p-4">
            <h3 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Top Performing Products</h3>
            <div className="space-y-1 sm:space-y-2">
              {salesData.topProducts && salesData.topProducts.length > 0 ? salesData.topProducts.slice(0, 5).map((product, index) => (
                <div key={product.id} className="flex items-center justify-between p-1.5 sm:p-2 bg-gray-50 rounded-lg">
                  <div className="flex items-center">
                    <span className="text-xs font-medium text-gray-500 w-4 sm:w-5">{index + 1}</span>
                    <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 sm:gap-3 lg:gap-4 mb-2 sm:mb-3 lg:mb-4">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-2 sm:p-3 lg:p-4">
            <h3 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Order Status</h3>
            <div className="space-y-1 sm:space-y-2">
              {salesData.orderStatus && salesData.orderStatus.length > 0 ? salesData.orderStatus.map(status => (
                <div key={status.status} className="flex items-center justify-between p-1.5 sm:p-2 bg-gray-50 rounded-lg">
                  <div className="flex items-center">
          ...
          {/* Revenue by Month */}
          <div className="bg-white rounded-lg border border-gray-200 p-2 sm:p-3 lg:p-4">
            <h3 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Revenue by Month</h3>
            <div className="space-y-1 sm:space-y-2">
          ...
          {/* Customer Insights */}
          <div className="bg-white rounded-lg border border-gray-200 p-2 sm:p-3 lg:p-4">
            <h3 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Customer Insights</h3>
            <div className="space-y-1 sm:space-y-2">
        ...
        {/* Recent Transactions */}
        <div className="bg-white rounded-lg border border-gray-200 p-2 sm:p-3 lg:p-4 mb-2 sm:mb-3 lg:mb-4">
          <h3 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Recent Transactions</h3>
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-1 sm:px-2 lg:px-4 py-1.5 sm:py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Order ID</th>
                  <th className="px-1 sm:px-2 lg:px-4 py-1.5 sm:py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Product</th>
                  <th className="px-1 sm:px-2 lg:px-4 py-1.5 sm:py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Customer</th>
                  <th className="px-1 sm:px-2 lg:px-4 py-1.5 sm:py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Amount</th>
                  <th className="px-1 sm:px-2 lg:px-4 py-1.5 sm:py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status</th>
                  <th className="px-1 sm:px-2 lg:px-4 py-1.5 sm:py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Date</th>
                </tr>
              </thead>
              <tbody className="bg-white divide-y divide-gray-200">
                {salesData.recentTransactions && salesData.recentTransactions.length > 0 ? salesData.recentTransactions.map(transaction => (
                  <tr key={transaction.id} className="hover:bg-gray-50">
                    <td className="px-1 sm:px-2 lg:px-4 py-2 sm:py-3 whitespace-nowrap text-xs font-medium text-gray-900">#{transaction.id}</td>
                    <td className="px-1 sm:px-2 lg:px-4 py-2 sm:py-3 whitespace-nowrap text-xs text-gray-900">{transaction.productName}</td>
                    <td className="px-1 sm:px-2 lg:px-4 py-2 sm:py-3 whitespace-nowrap text-xs text-gray-900">{transaction.customerName}</td>
                    <td className="px-1 sm:px-2 lg:px-4 py-2 sm:py-3 whitespace-nowrap text-xs font-medium text-gray-900">{formatCurrency(transaction.amount)}</td>
                    <td className="px-1 sm:px-2 lg:px-4 py-2 sm:py-3 whitespace-nowrap">
                    ...
                    <td className="px-1 sm:px-2 lg:px-4 py-2 sm:py-3 whitespace-nowrap text-xs text-gray-500">{formatDate(transaction.date)}</td>
                  </tr>
                )) : (
                  <tr>
                    <td colSpan="6" className="px-1 sm:px-2 lg:px-4 py-4 sm:py-6 text-center text-gray-500">
        ...
        {/* Export Options */}
        <div className="mt-2 sm:mt-3 lg:mt-6 flex flex-col sm:flex-row justify-end gap-1.5 sm:gap-2 lg:gap-3">
          <button className="w-full sm:w-auto bg-green-600 text-white px-3 sm:px-4 py-1.5 sm:py-2 text-xs rounded-lg font-medium hover:bg-green-700 transition-colors">
            Export to Excel
          </button>
          <button className="w-full sm:w-auto bg-blue-600 text-white px-3 sm:px-4 py-1.5 sm:py-2 text-xs rounded-lg font-medium hover:bg-blue-700 transition-colors">
            Generate PDF Report
          </button>
        </div>
      </div>
